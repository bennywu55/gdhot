    ...
    <div class="web-course-banner">
      <div class="container">
        ...
        <span class="course-text"
          >Python语言下最强大优秀的WEB框架从入门到进阶</span
        >
        <div class="course-list">
          <ul>
            <li class="detail-item">难度：初级</li>
            <li class="sep"></li>
      ...
      <div class="container">
        <div class="course-detail-text">
          ...
          <p>
            ...
            the course now and start to build your first web program based on
            Django.
          </p>
        </div>
        <div class="course-img">
          <img
            src="https://hcdn2.luffycity.com/media/frontend/public_class/Linux1@2x_1566529820.6731546.png"
            alt=""
          />
        </div>
      </div>
    ...
    <div class="course-price">
      <div class="container">
        ...
        <div class="course-action">
          <button class="left" @click="BuyCourse">购买</button>
...
export default {
  ...
  created() {
    ...
    this.getCourseDetail(courseid, params);
  },
};
</script>
